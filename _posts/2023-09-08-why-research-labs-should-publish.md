...
This post is about a question that often comes up in industrial research: **why should research labs publish papers?**  I believe there are many good reasons for this, and they are not immediately obvious.   (Obviously, this post expresses my own personal opinions, not those of any organizations.)
...
Some subsequent labs tried to be "Xerox PARC, but successful." One of these was [Interval Research](https://en.wikipedia.org/wiki/Interval_Research_Corporation), where I worked as [a summer intern with Trevor Darrell](https://people.eecs.berkeley.edu/~trevor/papers/1998-045/) in 1998.  There were a lot of amazing and inspiring people at Interval with so many different areas of expertise and passion.  Interval's management told researchers "if you're doing research that's less than 10 years to commercialization, then you're thinking too short-term"... but the lab closed down after only 8 years in existence, with very little to show for all that time and money.
...
While this is a good reason to publish, treating publication as merely an employee benefit—like breakroom snacks and vacation time—is a big mistake. **_Publication should not be something that researchers are "allowed" to do in addition to their "real work." It should be considered a major part of their real work._**
...
Suppose you wanted detailed feedback on a project from experts in your community.  How much would it cost? How hard would it be to recruit them?  It would be expensive, if you could get them to respond at all.
