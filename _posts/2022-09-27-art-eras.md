...
Artists resisted the idea of rationality and industrialization that had led to two disastrous World Wars and mass dehumanization. 
Yet, art became an Enlightenment-esque project toward perfect art. 
...
But as abstraction petered out, other movements searched for every greater purity of form (e.g., conceptualism), and others became more self-consciously engaged with popular culture (pop art).
...
The Modernist notion of progress ended when they'd broken down nearly all definitional barriers of art; almost anything can be art if an artist says so. Postmodernist philosophy attacked Enlightenment notions of progress, which it associated with colonalism and oppression. Art criticism began to avoid judgements at all, becoming suspicious of value judgements entirely (as described by James Elkins). As a result, the Contemporary Art world doesn't aim for progress or improvement; it's not trying to answer questions about "what is art?" or to make progress in art. 
