...
I tried to create more following the same way. I would often start with some sort of "real-ish" scene, and then add "natural-ish" textures and strokes. Here are some of my favorites:
<center>
