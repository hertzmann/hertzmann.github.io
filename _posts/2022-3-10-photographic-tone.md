...
We don't normally see the world this way. Our eyes adapt to extreme ranges of sunlight using several mechanisms, including dilating our irises when it's darker out, as well as sophisticated image processing that happens in the brain (such as a process called [contrast adaptation](https://medicine.yale.edu/lab/mccormick/seminars/contrast/)).
