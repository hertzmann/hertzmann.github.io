...
I've heard from other colleagues about projects that had similarly circuitous routes. The PatchMatch algorithm, which became "Content-Aware Fill," began as an attempt to summarize videos. DALL-E began as an attempt to improve language models using image data.
...
And, I had a project beginning the following year, in which one of the key insights arose from communication difficulties.