...
**The discussion of harms should focus on threats to current working artists,** including threats to employment. I believe that studying history can provide examples of how to respond to these threats, though I don't attempt to say anything to say about solutions here.  New technologies in the past 200 years have put some kinds of artists out of work (or forced them to retrain in new technologies). That these problems have a real impact on peoples' lives shouldn't be dismissed by pointing to the long march of progress.
