...
**The discussion of harms should focus on the threats to current working artists.**  This includes the labor risks—threats to employment—and other harms that artists have raised, such as having one's name become associated with a prompt.  In most or all cases, these harms are about _labor_, not _art_. I believe that studying history can provide examples of how to respond to this threat, although I don't go into this much here.  That these problems have a real impact on peoples' lives shouldn't be dismissed by pointing to the long march of progress.
