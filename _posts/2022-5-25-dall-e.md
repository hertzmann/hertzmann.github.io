...
For many applied tasks, like professional graphic design and illustration, you need a lot of control that DALL-E doesn't provide.  The initial GANs didn't have them either, but lots of research followed the initial GAN papers to add many kinds of control and interaction. I anticipate a lot of new research papers adding those kinds of controls to diffusion models (like DALL-E) in the next few years as well.

Of course the underlying technology is going to keep improving; this week, [Google announced Imagen](https://imagen.research.google/), a parallel effort using similar technology that claims even better results for photorealistic images.  They claim to have better ethical practices that, sadly, mean it might be less artistically interesting.
...
I've started to consider what I do with DALL-E to be both an exploration, and a form of art. In this, I am influenced by artists like [Ryan Murdoch](https://twitter.com/advadnoun) and [Helena Sarin](https://twitter.com/NeuralBricolage/status/1529580210278043653) who have vigorously advocated for this kind of prompt-based image-making to be recognized as art, even if it's amateur art like [the drawings I make on my iPad](https://www.instagram.com/aaronhertzmann/).
...
It's too early to judge the significance of this art form. A phrase from the excellent book [_Art in the After-Culture_](https://www.haymarketbooks.org/books/1662-art-in-the-after-culture) keeps sticking in my head: "The dominant AI aesthetic is novelty."   Surely this would be true, to some extent, for any new technology used for art.  The [first films by the Lumière brothers](https://www.youtube.com/watch?v=4nj0vEO4Q6s) weren't cinematic novelties; it was amazing to see the images moving at all. (That quote comes from a chapter critiquing the way AI art benefits big technology companies.) Given [how fast AI art software develops](https://aaronhertzmann.com/2021/03/11/lifecycle.html), it seems each year we're exploring an exciting new technology, more powerful than the last.
