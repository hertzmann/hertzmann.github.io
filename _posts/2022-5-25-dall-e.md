...
A drive up the California coast led to the idea for my next series: [classic computer graphics images](https://twitter.com/AaronHertzmann/status/1527743411351982081?s=20&t=q9WSyjMbYXdViQxnEyLc6w). Commentson
...
for that post led to the following series, [portraits of friends and colleagues](https://twitter.com/AaronHertzmann/status/1529100591464521728).
Here are two portrait that came directly from the prompt each person provided, without iteration:
