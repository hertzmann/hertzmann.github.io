...
For many applied tasks, like professional graphic design and illustration, you need a lot of control that DALL-E doesn't provide.  The initial GANs didn't have them either, but lots of research followed the initial GAN papers to add many kinds of control and interaction. I anticipate a lot of new research papers applying those kinds of controls to diffusion models (like DALL-E) in the next few years as well.
