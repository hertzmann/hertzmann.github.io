...
A lot of the discussion around tools like DALL-E focuses on compositionality, and its difficulty with concepts like ["A red cube on top of a blue cube"](https://twitter.com/raphaelmilliere/status/1514619771538477062).

To me, I found DALL-E's ability to compose concepts really stunning. For example, I could ask for, say, candid Polaroids of a polar bear's vacation, and not only would it generate a realistic polar bear, but it would look like an awkward holiday picture with Polaroid photo processing. And then if I tried "candid Polaroids of a clown brunch", I would get 10 high-quality, very different pictures of clown's having a good time at brunch; I could easily imagine these pictures stuff in a shoebox in the back of some ex-clown's closet.
...
A roboticist colleague recently asked for images of her collaborating with a robot, in scenes like "a robot arm pours coffee for a woman," similar to her [current profile photo](http://people.eecs.berkeley.edu/~anca/). DALL-E generally got all the elements in the scene, but often randomly mixing-and-matching concepts, making the woman into a robot or a woman with robot arms; having her pour the coffee; putting two coffee cups in her hands; giving her three arms; and so on. This was in addition to its frequent struggles with fingers and faces, which remind me of the indeterminate results common in GANs.  I tried a variety of visual styles (even if realistic faces were allowed, they often work only in simpler scenes), and changing the artist changes the content.  Using a 1950s science fiction artist like Rowena Morrill made the clothing, robot, and setting frumpy and old-fashioned; using Syd Mead led to many sexualized images.  We spent a lot of time poring over many different results and trying different visual styles (this is really addictive!).  After considerable trial-and-error, we found some prompts that worked well, such as:
...
which has some good outputs, like:
...
It's staggering that an algorithm can do this.  There's no existing way to pump out so many great results so quickly—not even by hiring an artist—and there were some good images scattered among the results.
...
I've started to consider what I do with DALL-E to be both an exploration, and a form of art. In this, I am influenced by artists like [Ryan Murdoch](https://twitter.com/advadnoun) and [Helena Sarin](https://twitter.com/NeuralBricolage/status/1529580210278043653) who have advocated for this kind of prompt-based image-making to be recognized as art, even if it's amateur art like [the drawings I make on my iPad](https://www.instagram.com/aaronhertzmann/).
